...
<template>
  <details class="panel">
    <summary class="panel-head">
      ...
      <span class="panel-title">{{ t('notes.title') }}</span>
    ...
    <div class="panel-body">
      ...
      <p v-else class="panel-hint">{{ t('notes.empty') }}</p>
      <div v-if="aiNotes.length" class="ai-sect-foot">
        <button class="btn btn-ghost btn-sm" @click="clearNotes()">{{ t('notes.clear') }}</button>
      </div>
    </div>
  </details>
</template>
